...
"""autogenerated by genpy from system_monitor/DiagnosticHDD.msg. Do not edit."""
import codecs
import sys
...
class DiagnosticHDD(genpy.Message):
  _md5sum = "90b65e631e647c3f69d6475dcbed9297"
  _type = "system_monitor/DiagnosticHDD"
...
"""
  ...
  _slot_types = ['string','string','string','system_monitor/HDDStatus']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DiagnosticHDD, self).__init__(*args, **kwds)
      ...
      if self.status is None:
        self.status = system_monitor.msg.HDDStatus()
    else:
      self.name = ''
      self.message = ''
      self.hardware_id = ''
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self.status.space_reading
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.status.disks)
      buff.write(_struct_I.pack(length))
      for val1 in self.status.disks:
        _x = val1.id
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.status.space_reading = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.status.space_reading = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.status.disks = []
