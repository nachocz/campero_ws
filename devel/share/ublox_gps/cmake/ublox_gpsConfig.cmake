...
if("TRUE" STREQUAL "TRUE")
  set(ublox_gps_SOURCE_PREFIX /home/pc-campero2/campero_ws/src/campero/ublox/ublox_gps)
  set(ublox_gps_DEVEL_PREFIX /home/pc-campero2/campero_ws/devel)
  ...
  set(ublox_gps_INSTALL_PREFIX /home/pc-campero2/campero_ws/install)
...
if(NOT "/home/pc-campero2/campero_ws/src/campero/ublox/ublox_gps/include " STREQUAL " ")
  set(ublox_gps_INCLUDE_DIRS "")
  set(_include_dirs "/home/pc-campero2/campero_ws/src/campero/ublox/ublox_gps/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pc-campero2/campero_ws/src/campero/ublox/ublox_gps/${idir}'.  ${_report}")
    endif()
