...
if("TRUE" STREQUAL "TRUE")
  set(sicktoolbox2_SOURCE_PREFIX /home/pc-campero2/campero_ws/src/campero/laser_drivers/sicktoolbox2)
  set(sicktoolbox2_DEVEL_PREFIX /home/pc-campero2/campero_ws/devel)
  ...
  set(sicktoolbox2_INSTALL_PREFIX /home/pc-campero2/campero_ws/install)
...
if(NOT "/home/pc-campero2/campero_ws/src/campero/laser_drivers/sicktoolbox2/include " STREQUAL " ")
  set(sicktoolbox2_INCLUDE_DIRS "")
  set(_include_dirs "/home/pc-campero2/campero_ws/src/campero/laser_drivers/sicktoolbox2/include")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://sicktoolbox.sourceforge.net " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'yanma <yanma@clearpathrobotics.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sicktoolbox2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'sicktoolbox2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pc-campero2/campero_ws/src/campero/laser_drivers/sicktoolbox2/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT sicktoolbox2_NUM_DUMMY_TARGETS)
      set(sicktoolbox2_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::sicktoolbox2::wrapped-linker-option${sicktoolbox2_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR sicktoolbox2_NUM_DUMMY_TARGETS "${sicktoolbox2_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::sicktoolbox2::wrapped-linker-option${sicktoolbox2_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND sicktoolbox2_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${sicktoolbox2_dep}_FOUND)
      find_package(${sicktoolbox2_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${sicktoolbox2_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
