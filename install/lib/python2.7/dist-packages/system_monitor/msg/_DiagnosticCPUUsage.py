...
"""autogenerated by genpy from system_monitor/DiagnosticCPUUsage.msg. Do not edit."""
import codecs
import sys
...
class DiagnosticCPUUsage(genpy.Message):
  _md5sum = "612aee1cee68c976c5b1d1ecf7006c25"
  _type = "system_monitor/DiagnosticCPUUsage"
...
float32 idle"""
  ...
  _slot_types = ['string','string','string','system_monitor/CPUUsageStatus']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DiagnosticCPUUsage, self).__init__(*args, **kwds)
      ...
      if self.status is None:
        self.status = system_monitor.msg.CPUUsageStatus()
    else:
      self.name = ''
      self.message = ''
      self.hardware_id = ''
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3f().pack(_x.status.load_avg1, _x.status.load_avg5, _x.status.load_avg15))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.status.load_status = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.status.load_status = str[start:end]
      _x = self
      start = end
      end += 12
      (_x.status.load_avg1, _x.status.load_avg5, _x.status.load_avg15,) = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.status.cores = []
