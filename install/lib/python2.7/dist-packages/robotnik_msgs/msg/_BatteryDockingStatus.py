...
class BatteryDockingStatus(genpy.Message):
  _md5sum = "16af3d7230e4454981667998006e8e68"
...
"""
  ...
  __slots__ = ['operation_mode','battery_current','contact_relay_status','charger_relay_status']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       operation_mode,battery_current,contact_relay_status,charger_relay_status
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_f2B().pack(_x.battery_current, _x.contact_relay_status, _x.charger_relay_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.battery_current, _x.contact_relay_status, _x.charger_relay_status,) = _get_struct_f2B().unpack(str[start:end])
